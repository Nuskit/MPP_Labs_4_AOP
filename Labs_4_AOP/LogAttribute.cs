...
namespace Labs_4_AOP
{
  ...
  public class LogAttribute : Attribute
  {
    ...
    private string GetParameterBlock(Dictionary<string, Pair<ParameterType,object>> currentParameters)
    {
      StringBuilder parameterInfo = new StringBuilder(100);
      foreach (var parameterName in currentParameters.Keys)
      {
        parameterInfo.Append(String.Format("{0} = {1}", parameterName, currentParameters[parameterName].Second));
      }
    ...
    public virtual void OnEnter(System.Reflection.MethodBase currentMethod, 
      Dictionary<string, Pair<ParameterType, object>> currentParameters)
    {
